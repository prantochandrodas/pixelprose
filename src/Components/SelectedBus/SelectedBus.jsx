...
const SelectedBus = () => {
    ...
    return (
        <div className="w-[90%]  lg:flex md:flex mx-auto mt-32 justify-center">
            <SelectedBusForm setShowModal={setShowModal} selectedBus={selectedBus} />
            <div className="lg:w-[800px] md:w-[800px] w-full mb-10">
                <div className="lg:w-[400px] md:w-[400px] w-full lg:ml-5 border border-gray-400">
