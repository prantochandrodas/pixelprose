                    ...
                    <div className="p-4">
                        <div className="flex justify-between my-3">
                            <div className="flex items-center gap-[5px]">
                                ...
                                <div className={`w-[40px] h-[60px]  flex items-center justify-center border border-gray-400 ${selectedSeats.includes(selectedBus.seat[1]) ? 'bg-green-400 text-white' : ''}`} onClick={() => handleSeatClick(selectedBus.seat[1])}>{selectedBus.seat[1]}</div>
                            </div>
                            <div className="flex items-center gap-[5px]">
