...
const BuySteps = () => {
    return (
        <div className="lg:my-[100px] md:my-[100px] mt-[300px]">
            ...
            <div className="flex lg:flex-row md:flex-row  md:flex-wrap flex-col  items-center justify-center my-10 md:gap-[20px] gap-[30px] lg:gap-[50px]">
                    <div className="flex flex-col justify-center lg:w-[400px] md:w-[350px] w-[90%] mx-auto items-center shadow-2xl border border-lg border-gray-200  h-[300px]">
